...
import 'package:neumorphismApp/nm_box.dart';
      ...
      children: <Widget>[
        Row(
          ...
          children: <Widget>[
            ...
            Text('€' + transLimit.toStringAsFixed(0))
          ],
        ),
        SliderTheme(
...
class NMButton extends StatelessWidget {
  ...
  const NMButton({Key key, this.down, this.icon});
...
class NMCard extends StatelessWidget {
  ...
  final IconData icon;
  final String label;
  const NMCard({Key key, this.active, this.icon, this.label});
